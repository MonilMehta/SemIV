...
firstN = twoscomplement(firstP) #contains 2's complement of the multiplicand
secondN = twoscomplement(secondP) #contains 2's complement of the multiplier
...
if negative_a==negative_b:
    ...
    ans_d = "-" + str(int(twoscomplement(answer),2))
